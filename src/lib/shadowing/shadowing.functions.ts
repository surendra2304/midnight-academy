...
export const SEEDED_SHADOWING_BANK: ShadowingItem[] = [
  ...
  {
    id: 'shad-014',
    sentence: 'The professor highlighted three primary factors that contributed to the economic recession.',
  ...
  {
    id: 'shad-015',
    sentence: 'Recent meteorological data suggests a notable rise in average oceanic surface temperatures.',
  ...
  {
    id: 'shad-016',
    sentence: 'Although the initial hypothesis was promising, subsequent experiments yielded conflicting results.',
  ...
  {
    id: 'shad-017',
    sentence: 'Cognitive psychologists investigate how mnemonic strategies enhance long-term information retention.',
    topic: 'Psychology',
    difficulty: 'middle',
  ...
  {
    id: 'shad-018',
    sentence: 'Urban infrastructure projects require comprehensive environmental impact assessments prior to approval.',
  ...
  {
    id: 'shad-019',
    sentence: 'The artist’s deliberate use of asymmetrical composition creates a compelling sense of visual tension.',
    topic: 'Art History',
    difficulty: 'middle',
  ...
  {
    id: 'shad-020',
    sentence: 'Microorganisms in deep hydrothermal vents thrive under extreme pressure and perpetual darkness.',
    topic: 'Oceanography',
    difficulty: 'middle',
  ...
  {
    id: 'shad-021',
    sentence: 'Statistical variance must be accounted for when evaluating patient responses to clinical treatments.',
    topic: 'Biostatistics',
    difficulty: 'middle',
  ...
  {
    id: 'shad-022',
    sentence: 'Renewable energy integration diminishes long-term operational expenditures across municipal power grids.',
  ...
  {
    id: 'shad-023',
    sentence: 'Historical manuscripts preserved in specialized archives provide direct insight into medieval trade routes.',
    topic: 'World History',
    difficulty: 'middle',
  ...
  {
    id: 'shad-024',
    sentence: 'The architectural design optimizes natural ventilation to minimize artificial heating and cooling demands.',
  ...
  {
    id: 'shad-025',
    sentence: 'Cross-cultural negotiations frequently require participants to decode implicit nonverbal behavioral cues.',
  ...
  {
    id: 'shad-026',
    sentence: 'Biochemical catalysts accelerate cellular metabolic pathways without being consumed in the reaction.',
    topic: 'Biochemistry',
    difficulty: 'middle',
  ...
  {
    id: 'shad-027',
    sentence: 'Epistemological debates concerning empirical determinism have profoundly influenced contemporary philosophical paradigms.',
    topic: 'Epistemology',
    difficulty: 'upper',
  ...
  {
    id: 'shad-028',
    sentence: 'The spectroscopic identification of interstellar organic molecules suggests prebiotic chemical synthesis is ubiquitous throughout galaxies.',
    topic: 'Astrobiology',
    difficulty: 'upper',
  ...
  {
    id: 'shad-029',
    sentence: 'Macroeconomic equilibrium models must incorporate stochastic volatility parameters to accurately forecast market liquidity.',
  ...
  {
    id: 'shad-030',
    sentence: 'Comparative sociological methodologies reveal that institutional norms perpetually reconfigure collective identity narratives.',
  ...
  {
    id: 'shad-031',
    sentence: 'Neuroimaging paradigms demonstrate that synaptic plasticity facilitates adaptive recalibration in perceptual processing networks.',
  ...
  {
    id: 'shad-032',
    sentence: 'Constitutional jurisprudence balances sovereign executive authority against statutory legislative prerogatives.',
    topic: 'Jurisprudence',
    difficulty: 'upper',
  ...
  {
    id: 'shad-033',
    sentence: 'Cryptographic decentralization protocols eliminate centralized intermediary risks through distributed consensus mechanisms.',
  ...
  {
    id: 'shad-034',
    sentence: 'Geomorphological sedimentation rates in fluvial estuaries fluctuate in direct proportion to anthropogenic deforestation.',
    topic: 'Geomorphology',
    difficulty: 'upper',
  ...
  {
    id: 'shad-035',
    sentence: 'Post-colonial literary narratives deliberately subvert traditional hegemonic discourse through multilingual vernacular integration.',
  ...
  {
    id: 'shad-036',
    sentence: 'Quantum mechanical superposition enables simultaneous state computation prior to wavefunction collapse upon measurement.',
  ...
  {
    id: 'shad-037',
    sentence: 'Immunological monoclonal antibody therapies precisely target malignant antigens while preserving adjacent healthy somatic tissue.',
    topic: 'Immunology',
    difficulty: 'upper',
  ...
  {
    id: 'shad-038',
    sentence: 'Algorithmic optimization in deep neural networks often encounters non-convex loss surfaces that impede global convergence.',
  ...
  {
    id: 'shad-039',
    sentence: 'Thermodynamic entropy increments inevitably constrain the theoretical efficiency thresholds of thermoelectric energy converters.',
  ...
  {
    id: 'shad-040',
    sentence: 'Anthropological ethnographies emphasize how ritualistic gift exchange consolidates reciprocal intertribal alliances.',
  ...
  .handler(async ({ data }): Promise<ShadowingEvaluationResult> => {
    ...
    if (!studentSpoken) {
      return {
        ...
        coachingFeedback: 'Ensure your microphone is enabled and speak immediately after the countdown.',
      };
    }
    ...
    try {
      ...
      if (parsed.success) {
        const d = parsed.data;
        const pron = d.traits.pronunciation || Math.min(6.0, Math.max(1.0, (wordDiff.accuracyPercent / 100) * 5 + 1));
        const deliv = d.traits.delivery || Math.min(6.0, Math.max(1.0, (wordDiff.accuracyPercent / 100) * 5 + 1));
        const avgBand = Math.round(((d.score_band + (wordDiff.accuracyPercent / 100) * 5 + 1) / 2) * 2) / 2;
        ...
        return {
          ...
          strengths: d.strengths.length > 0 ? d.strengths : ['Solid sentence completion and vocal effort.'],
          pronunciationNotes: d.issues.length > 0 ? d.issues : ['Smooth rhythm with natural phrasing.'],
          coachingFeedback: d.next_actions[0] || 'Focus on linking words naturally across thought groups.',
        };
      }
    } catch {
    ...
    return {
      ...
      strengths: wordDiff.accuracyPercent >= 80 ? ['Clear phonetic repetition and rhythm.'] : ['Good vocal projection.'],
      pronunciationNotes:
      ...
      coachingFeedback: 'Practice shadowing each sentence until you achieve 90%+ word accuracy and fluid pacing.',
    };
  });
