...
export const SEEDED_DICTATION_BANK: DictationItem[] = [
  ...
  },
  {
    id: "dict-009",
    sentence:
      "The career fair provides direct networking opportunities with international employers.",
  ...
  // Middle Band (Intermediate Discussions & Lectures)
  {
    id: "dict-011",
    sentence:
      "Recent archaeological findings challenge previous assumptions regarding early agricultural settlements.",
    topic: "Archaeology",
    difficulty: "middle",
  ...
  },
  {
    id: "dict-012",
    sentence:
      "Photosynthesis converts solar energy into chemical compounds through complex biochemical reactions.",
    topic: "Biology",
    difficulty: "middle",
  ...
  },
  {
    id: "dict-013",
    sentence:
      "Urban development plans should balance economic expansion with environmental preservation.",
  ...
  },
  {
    id: "dict-014",
    sentence:
      "The statistical analysis revealed a strong correlation between sleep patterns and cognitive performance.",
    topic: "Psychology",
    difficulty: "middle",
  ...
  },
  {
    id: "dict-015",
    sentence:
      "Volcanic eruptions release significant quantities of sulfur dioxide into the upper atmosphere.",
    topic: "Geology",
    difficulty: "middle",
  ...
  },
  {
    id: "dict-016",
    sentence:
      "Renaissance artists utilized innovative geometric perspectives to produce realistic visual depths.",
    topic: "Art History",
    difficulty: "middle",
  ...
  },
  {
    id: "dict-017",
    sentence:
      "Economists predict that interest rate adjustments will stimulate capital investment in technology.",
    topic: "Economics",
    difficulty: "middle",
  ...
  },
  {
    id: "dict-018",
    sentence:
      "Migratory marine species navigate ocean currents by detecting natural magnetic field variations.",
  ...
  },
  {
    id: "dict-019",
    sentence:
      "Renewable energy generation requires substantial initial investment in modern power grid infrastructure.",
  ...
  },
  {
    id: "dict-020",
    sentence:
      "The peer review committee evaluated the grant proposal with extreme methodological rigor.",
  ...
  // Upper Band (Advanced Academic Discourse & Fast Connected Speech)
  {
    id: "dict-021",
    sentence:
      "Epistemological distinctions between empirical observation and theoretical deduction remain fundamental in modern philosophy.",
    topic: "Philosophy",
    difficulty: "upper",
  ...
  },
  {
    id: "dict-022",
    sentence:
      "Gravitational lensing provides compelling empirical evidence for the existence of non-luminous dark matter.",
    topic: "Astrophysics",
    difficulty: "upper",
  ...
  },
  {
    id: "dict-023",
    sentence:
      "Sociolinguistic variations among demographic subgroups demonstrate how linguistic norms evolve through cultural interaction.",
    topic: "Linguistics",
    difficulty: "upper",
  ...
  },
  {
    id: "dict-024",
    sentence:
      "Thermodynamic equilibrium in closed ecological systems cannot be sustained without continuous external energy dissipation.",
  ...
  },
  {
    id: "dict-025",
    sentence:
      "Comparative constitutional jurisprudence highlights how institutional checks and balances mitigate sovereign overreach.",
  ...
  },
  {
    id: "dict-026",
    sentence:
      "Neuroplasticity enables neural pathways to reorganize dynamically in response to systemic physiological stimuli.",
    topic: "Neuroscience",
    difficulty: "upper",
  ...
  },
  {
    id: "dict-027",
    sentence:
      "Algorithmic efficiency in large-scale distributed computing depends critically upon minimizing inter-node latency bottlenecks.",
  ...
  },
  {
    id: "dict-028",
    sentence:
      "Paleoclimatic ice-core samples reveal unprecedented atmospheric greenhouse gas concentrations over millennial timescales.",
    topic: "Climatology",
    difficulty: "upper",
  ...
  },
  {
    id: "dict-029",
    sentence:
      "Post-structuralist literary criticism deconstructs binary oppositions embedded within conventional canonical narratives.",
  ...
  },
  {
    id: "dict-030",
    sentence:
      "Biomedical nanotechnology facilitates targeted pharmacological delivery while attenuating unintended collateral cytotoxicity.",
    topic: "Nanomedicine",
    difficulty: "upper",
...
export const submitDictationAttempt = createServerFn({ method: "POST" })
  ...
  .handler(async ({ data, context }): Promise<DictationSubmissionResult> => {
    ...
    if (
      data.requestAiExplanation &&
      !score.isPerfectMatch &&
      score.wrongWordCount + score.missingWordCount > 0
    ) {
      try {
        ...
        const prompt = [
          ...
          'Return JSON: { "explanation": "<coaching text>" }',
        ].join("\n\n");

        const aiResponse = await chatJson<{ explanation: string }>([
          { role: "system", content: "You are an expert English listening pronunciation tutor." },
          { role: "user", content: prompt },
        ]);

        if (aiResponse?.explanation && aiResponse.explanation.trim().length > 0) {
          aiExplanation = aiResponse.explanation.trim();
        }
      } catch {
        // Fallback rule-based explanation
        aiExplanation =
          'Pay attention to unstressed syllables, weak forms (like "of", "to", "and"), and fast-speech reductions in academic lectures.';
      }
    }
