...
| ------ | -------------------------------- | ---------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------- | :-------------: |
| **1**  | **Full-Length Mock Series**      | 6+ named full mock tests with 4 sections | **6 Named Series** (_Lunar, Solar, Nebula, Eclipse, Polaris, Aurora_) with multistage adaptive routing and 1–6 band + 0–120 estimated scoring | ✅ **VERIFIED** |
