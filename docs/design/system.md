...
- `--border`: `rgba(255, 255, 255, 0.08)` (Subtle, crisp demarcation)
...
- `--success`: `#34d399` (Emerald — correct answers & high band mastery)
- `--warning`: `#fbbf24` (Amber — timers & medium band indicators)
- `--destructive`: `#f87171` (Crimson — wrong answers & error badges)
...
- `--shadow-elev`: `0 4px 20px -2px rgba(0, 0, 0, 0.5)`
- `--shadow-glow`: `0 0 0 1px rgba(56, 189, 248, 0.25), 0 4px 24px -2px rgba(56, 189, 248, 0.2)`
