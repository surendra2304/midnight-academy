...
export async function seedSubstantialToeflBank() {
      ...
      traits: [
        {
          ...
          weight: 0.35,
          description: "Directly addresses prompt requirements and recipient tone",
          maxScore: 6.0,
        },
        {
          name: "organization",
          weight: 0.3,
          description: "Logical flow, paragraphs, greetings, and closing",
          maxScore: 6.0,
        },
        {
          name: "language_use",
          weight: 0.35,
          description: "Grammar control, syntactic variety, vocabulary range",
          maxScore: 6.0,
        },
      ],
      band_descriptors: {
      ...
      traits: [
        {
          name: "task_fulfillment",
          weight: 0.4,
          description: "Relevant contribution with developed ideas and classmate engagement",
          maxScore: 6.0,
        },
        {
          name: "organization",
  ...
  const readingItems = [
    {
      ...
      payload: {
        ...
        passage:
          "Hydroelectric dams generate [0] electricity without burning fossil fuels. Water stored in reservoirs passes through turbines to [1] mechanical power into electric currents.",
        blanks: [
    ...
    },
    {
      ...
      payload: {
        ...
        passage:
          "Language acquisition in toddlers occurs [0] when caregivers engage in reciprocal conversations. Children who receive regular verbal stimulation demonstrate [1] vocabulary expansion during preschool years.",
        blanks: [
    ...
    },
    {
      ...
      payload: {
        ...
        passage:
          "The Student Health Center will offer complimentary seasonal influenza vaccines from October 15 to November 10. Walk-ins are accepted on weekdays between 9:00 AM and 3:00 PM in the West Wing Lounge. All attendees must present their student ID and complete a medical history form prior to immunization.",
      ...
      options: [
        ...
        {
          key: "B",
          text: "Saturday mornings from 8:00 AM to 12:00 PM",
          isCorrect: false,
          distractor: "Weekend hours are not offered.",
        },
        {
          key: "C",
          text: "Anytime throughout the calendar year",
          isCorrect: false,
          distractor: "The clinic runs strictly between Oct 15 and Nov 10.",
        },
        {
          key: "D",
          text: "Only during scheduled evening appointments",
          isCorrect: false,
          distractor: "The clinic operates on a walk-in basis during the day.",
        },
      ],
    },
    {
      ...
      payload: {
        ...
        passage:
          "Astronomers detect atmospheric signatures of exoplanets primarily through transmission spectroscopy during transit events. When an exoplanet crosses the disk of its host star, stellar light filters through the planet's atmospheric rim, imprinting distinct absorption lines corresponding to water vapor, methane, and carbon dioxide. However, high-altitude haze layers and photochemical clouds frequently attenuate these spectral features, creating a transmission spectrum that appears deceptively featureless.",
        prompt:
          "According to the passage, what is one major obstacle when attempting to detect water vapor in exoplanet atmospheres?",
      },
      options: [
        {
          key: "A",
          text: "High-altitude hazes and cloud layers mask spectral absorption lines",
          isCorrect: true,
          distractor: null,
        },
        {
          key: "B",
          text: "Exoplanets cannot be observed when passing in front of host stars",
          isCorrect: false,
          distractor: "Transit spectroscopy relies directly on exoplanets crossing stars.",
        },
        {
          key: "C",
          text: "Water vapor does not interact with stellar light",
          isCorrect: false,
          distractor: "Water vapor creates distinct spectral absorption lines.",
        },
        {
          key: "D",
          text: "Methane and carbon dioxide completely eradicate atmospheric water",
          isCorrect: false,
          distractor: "The text does not state that methane destroys water.",
        },
      ],
    },
  ];
  ...
  await supabase.from("content_items").upsert({
    ...
    payload: {
      ...
      context:
        "You are applying for a competitive summer research fellowship and need your faculty mentor to submit a letter of recommendation by Friday of next week.",
      prompt:
        "Write an email requesting the recommendation letter. Include details of the fellowship, the deadline, and offer to provide your updated resume.",
      modelAnswer:
  ...
  await supabase.from("content_items").upsert({
    ...
    payload: {
      ...
      discussionPosts: [
        {
          author: "Liam (Student)",
          text: "UBI provides an essential safety net in an age where automation is displacing millions of entry-level manufacturing and service jobs.",
        },
        {
          author: "Sophia (Student)",
          text: "Without tied work requirements, unconditional cash distributions will likely inflate consumer goods prices and create immense fiscal deficits for national treasuries.",
        },
      ],
      prompt:
        "Write a response contributing your perspective to the class debate. Support your argument with clear rationale and engage with the viewpoints of your peers.",
      modelAnswer:
        "In my view, implementing a targeted or phased Universal Basic Income is essential to mitigate the structural employment shocks driven by rapid artificial intelligence adoption...",
    },
    item_order: 2,
  });
  ...
  const speakingItems = [
    ...
    },
    {
      ...
      payload: {
        prompt:
          "Some people prefer taking vacation trips to bustling international cities, while others prefer quiet natural retreats such as mountains or beaches. Which travel style do you prefer and why? Explain with specific reasons.",
        preparationSeconds: 15,
        responseLimitSeconds: 45,
        modelAnswer:
          "I definitely prefer taking vacation trips to quiet natural retreats rather than bustling urban centers. First, spending time in natural environments allows me to mentally recharge from demanding academic schedules...",
      },
    },
  ];
