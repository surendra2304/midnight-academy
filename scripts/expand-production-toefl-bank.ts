  ...
  const expandedReading = [
    {
      ...
      payload: {
        ...
        passage:
          "Planting native trees in dense metropolitan areas [0] ambient summer temperatures. Canopy shade and evapotranspiration [1] urban heat island effects significantly.",
        blanks: [
    ...
    },
    {
      ...
      options: [
        ...
        {
          key: "B",
          text: "Into gray landfill receptacles by exit doors",
          isCorrect: false,
          distractor: "Gray bins are designated exclusively for non-compostables.",
        },
        {
          key: "C",
          text: "Into blue recyclable paper containers",
          isCorrect: false,
          distractor: "Blue bins are strictly for recyclable paper.",
        },
        {
          key: "D",
          text: "In designated student dormitory kitchens",
          isCorrect: false,
          distractor: "The passage concerns dining halls, not dorm kitchens.",
        },
      ],
    },
  ];
