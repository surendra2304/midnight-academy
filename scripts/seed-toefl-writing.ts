...
export async function seedToeflWritingBank() {
  ...
  await supabase.from("sections").upsert(
    {
      ...
      timing_seconds: 1380,
      instructions:
        "The Writing section measures your ability to write in English in an academic environment.",
    },
    { onConflict: "id" },
  );
  ...
  await supabase.from("rubrics").upsert([
    {
      ...
      traits: [
        ...
        },
        {
          name: "organization",
          weight: 0.3,
          description: "Clear paragraph structure, greeting, logical flow, and closing",
          maxScore: 6.0,
        },
        {
          name: "language_use",
          weight: 0.35,
          description: "Grammatical accuracy, syntactic variety, vocabulary range",
          maxScore: 6.0,
        },
      ],
      band_descriptors: {
        "6.0":
          "Fully successful fulfillment; natural, fluent, and idiomatic expression with precise vocabulary.",
        "5.0":
          "Generally successful fulfillment; minor grammatical or lexical slips that do not obscure meaning.",
      ...
      traits: [
        {
          name: "task_fulfillment",
          weight: 0.4,
          description: "Relevant contribution to discussion with developed ideas",
          maxScore: 6.0,
        },
        {
          name: "organization",
          weight: 0.3,
          description: "Coherent progression of reasoning and supporting details",
          maxScore: 6.0,
        },
        {
          name: "language_use",
          weight: 0.3,
          description: "Complex sentence structures, precise academic vocabulary",
          maxScore: 6.0,
        },
      ],
      band_descriptors: {
        "6.0":
          "Relevant and very well-developed contribution; consistent syntactic variety and appropriate academic register.",
        "5.0": "Relevant and mostly developed; contains minor lexical or grammatical flaws.",
        "4.0":
          "Understandable but underdeveloped idea with repetition or basic sentence structures.",
  ...
  await supabase.from("content_items").upsert({
    ...
    payload: {
      ...
      context:
        "You are planning your schedule for next semester, but two of your required courses have a time conflict. You need your advisor's guidance on alternative approved electives or permission to enroll in an online section.",
      prompt:
        "Write an email to your advisor explaining your situation. Include:\n- A polite explanation of the scheduling conflict\n- Two possible alternatives you have considered\n- A request for a brief advising meeting or written approval",
      modelAnswer:
