  ...
  describe("Speaking Evaluation Schema Validation", () => {
    it("validates structured speaking evaluation output with 5 trait dimensions", () => {
      const speakingEvaluationOutput = {
        ...
        strengths: [
          "Clearly articulated stance with two well-developed arguments",
          "High intelligibility and natural intonation",
        ],
        ...
        next_actions: [
          'Practice rapid transitions using phrases like "Furthermore" and "In addition".',
        ],
        confidence: 0.95,
